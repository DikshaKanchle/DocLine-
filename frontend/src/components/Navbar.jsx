  ...
  return (
    <div className='flex items-center justify-between text-sm py-6 mb-8 border-b border-orange-200 bg-gradient-to-r from-orange-50 to-teal-50 backdrop-blur-sm sticky top-0 z-50 shadow-sm'>
        ...
        <ul className='hidden md:flex items-center gap-8 font-medium'>
            <NavLink to='/'>
                <li className='py-2 px-4 rounded-lg hover:bg-orange-100 transition-colors duration-200 text-gray-700 hover:text-orange-600'>HOME</li>
                <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
            </NavLink>
            <NavLink to='/doctors'>
                <li className='py-2 px-4 rounded-lg hover:bg-orange-100 transition-colors duration-200 text-gray-700 hover:text-orange-600'>ALL DOCTORS</li>
                <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
            </NavLink>
            <NavLink to='/about'>
                <li className='py-2 px-4 rounded-lg hover:bg-orange-100 transition-colors duration-200 text-gray-700 hover:text-orange-600'>ABOUT</li>
                <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
            </NavLink>
            <NavLink to='/contact'>
                <li className='py-2 px-4 rounded-lg hover:bg-orange-100 transition-colors duration-200 text-gray-700 hover:text-orange-600'>CONTACT</li>
                <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
            </NavLink>
        </ul>
